...
namespace Opsive.BehaviorDesigner.Runtime.Tasks
{
    ...
    public abstract class Task : ISavableTask
    {
        ...
        internal virtual void Initialize(BehaviorTree behaviorTree, ushort runtimeIndex)
        {
            ...
            m_BehaviorTree.OnBehaviorTreeStarted += OnStarted;
            m_BehaviorTree.OnBehaviorTreeStopped += OnStopped;
            ...
            if (ReceiveDrawGizmosCallback) { m_BehaviorTree.OnBehaviorTreeDrawGizmos += OnDrawGizmos; }
            if (ReceiveDrawGizmosSelectedCallback) { m_BehaviorTree.OnBehaviorTreeDrawGizmosSelected += OnDrawGizmosSelected; }
        ...
        /// <summary>
        /// Callback when OnCollisionEnter is triggered. Ensure you can receive the callback by setting ReceiveCollisionEnterCallback to true.
        /// </summary>
        ...
        /// <summary>
        /// Callback when OnCollisionExit is triggered. Ensure you can receive the callback by setting ReceiveCollisionExitCallback to true.
        /// </summary>
        /// <param name="collision">The resulting collision.</param>
        ...
        /// <summary>
        /// Callback when OnCollisionEnter2D is triggered. Ensure you can receive the callback by setting ReceiveCollisionEnter2DCallback to true.
        /// </summary>
        /// <param name="collision">The resulting collision.</param>
        ...
        /// <summary>
        /// Callback when OnCollisionExit2D is triggered. Ensure you can receive the callback by setting ReceiveCollisionExit2DCallback to true.
        /// </summary>
        /// <param name="collision">The resulting collision.</param>
        ...
        /// <summary>
        /// Callback when OnTriggerEnter is triggered. Ensure you can receive the callback by setting ReceiveTriggerEnterCallback to true.
        /// </summary>
        ...
        /// <summary>
        /// Callback when OnTriggerExit is triggered. Ensure you can receive the callback by setting ReceiveTriggerExitCallback to true.
        /// </summary>
        /// <param name="other">The overlapping collider.</param>
        ...
        /// <summary>
        /// Callback when OnTriggerEnter2D is triggered. Ensure you can receive the callback by setting ReceiveTriggerEnter2DCallback to true.
        /// </summary>
        /// <param name="other">The overlapping collider.</param>
        ...
        /// <summary>
        /// Callback when OnTriggerExit2D is triggered. Ensure you can receive the callback by setting ReceiveTriggerExit2DCallback to true.
        /// </summary>
        /// <param name="other">The overlapping collider.</param>
        ...
        /// <summary>
        /// Callback when OnControllerColliderHit is triggered. Ensure you can receive the callback by setting ReceiveControllerColliderHitCallback to true.
        /// </summary>
        /// <param name="hit">The hit result.</param>
        protected virtual void OnControllerColliderHit(ControllerColliderHit hit) { }

        protected virtual bool ReceiveDrawGizmosCallback => false;
        /// <summary>
        /// Callback when OnDrawGizmos is triggered. Ensure you can receive the callback by setting ReceiveDrawGizmosCallback to true.
        /// </summary>
        protected virtual void OnDrawGizmos() { }

        protected virtual bool ReceiveDrawGizmosSelectedCallback => false;
        /// <summary>
        /// Callback when OnDrawGizmosSelected is triggered. Ensure you can receive the callback by setting ReceiveDrawGizmosSelectedCallback to true.
        /// </summary>
